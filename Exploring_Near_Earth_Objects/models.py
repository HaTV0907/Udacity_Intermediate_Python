...
class NearEarthObject:
    ...
    def __init__(self, pdes, name, diameter, hazadous):
    ...
    def serialize(self):
        """Constuct dict for writing to json file."""
        return {
            'name': self.name,
...
class CloseApproach:
    ...
    def time_str(self):
        ...
        # : Use self.designation and self.name to build a fullname for this object.
        return f"approach time={datetime_to_str(self.time)}"
    ...
    def __str__(self):
        ...
        return f"CloseApproach(time={self.time_str!r}, designation={self._designation!r} distance={self.distance:.2f}, " \
    ...
    def serialize(self):
        """Constuct dict for writing to json file."""
        # Assuming self.time is a datetime object
